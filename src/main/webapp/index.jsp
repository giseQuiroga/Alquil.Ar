	            			...
	            			<div class="row">
	              				...
	              				<div class="col-md-6 col-sm-6 col-xs-6">
	                				<div class="aa-header-right">
	                  					<a href="registro.html" class="aa-register">Registrarse</a>
	                  					<a href="ingreso.html" class="aa-login">Ingresar</a>
	                				</div>
	              				</div>
	            			</div>
	          			</div>
    		...
    		<nav class="navbar navbar-default main-navbar" role="navigation">  
      			<div class="container">
        			<div class="navbar-header">
          				...
          				<!-- LOGO -->                                               
          				<!-- Text based logo -->
           				<a class="navbar-brand aa-logo" href="index.html"> Alquil<span>.AR</span></a>
			        </div>
        			<div id="navbar" class="navbar-collapse collapse">
          				<ul id="top-menu" class="nav navbar-nav navbar-right aa-main-nav">
          				  	<li class="active"><a href="index.html">INICIO</a></li>
             				<li class="dropdown">
              					<a class="dropdown-toggle" data-toggle="dropdown" href="propiedades.html">PROPIEDADES <span class="caret"></span></a>
              					<ul class="dropdown-menu" role="menu">                
                					<li><a href="propiedades.html">Propiedaes</a></li>
                					<li><a href="detalles-propiedades.html">Detalles de propiedades</a></li>                                            
              					</ul>
            				</li>
            				<li><a href="galeria.html">GALERIA</a></li>                                         
            				<li class="dropdown">
              					<a class="dropdown-toggle" data-toggle="dropdown" href="inmobiliarias.html">INMOBILIARIAS <span class="caret"></span></a>
              					<ul class="dropdown-menu" role="menu">                
                					<li><a href="inmobiliarias.html">DESTACADAS</a></li>
                					<li><a href="blog-single.html">POR ZONA</a></li>                                            
              					</ul>
            				</li>
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="aa-single-advance-search">
                  <input type="text" placeholder="IngresÃ¡ por Zona, Cuidad o Provincia">
                </div>
              </div>
              <div class="col-md-2">
                <div class="aa-single-advance-search">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="aa-promo-banner-area">
            <h3>¡Encontrá la casa de tus sueños en ZonaProp Argentina!</h3>
